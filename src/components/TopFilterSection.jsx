...
export const TopFilterSection = () => {
    const {initialdata,setData,hide}=useContext(datacontext);
...
if(color==""&& gender==""&& type==""&&price==""){
  ...
  return (
    <div style={hide ? {height :'130px',transition:'0.5s'}: {height :'0px',overflow:'hidden',transition:'0.5s'}}>
        <div className='clearFilter' onClick={handleFilter} style={{fontWeight:'bold',cursor:'pointer'}}>Clear filter</div>
